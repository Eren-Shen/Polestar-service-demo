...
data class NotificationConfig(
     ...
     * 渠道id
     */
    var channelId: String = "Polestar",
    /**
     * 渠道名
     */
    var channelName: String = "Polestar",
    /**
     * 标题名
     */
    var title: String = "Polestar",
    /**
     * 通知栏内容
     */
    var content: String = "Polestar service is running...",
    /**
     * 小图标
     */
    ...
    constructor(source: Parcel) : this(
        source.readInt(),
        source.readString() ?: "Polestar",
        source.readString() ?: "Polestar",
        source.readString() ?: "Polestar",
        source.readString() ?: "The app of polestar is running",
        source.readInt(),
        source.readInt(),
