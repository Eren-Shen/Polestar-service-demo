...
import com.gyf.cactus.receiver.LocationReceiver
...
internal fun Context.registerLocationReceiver(block: () -> Unit) =
    LocationReceiver.newInstance(this).register(block)
/**
 * 注册Cactus服务
 *
 * @receiver Context
